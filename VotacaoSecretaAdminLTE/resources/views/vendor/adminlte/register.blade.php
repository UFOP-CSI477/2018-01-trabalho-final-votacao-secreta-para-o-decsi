            ...
            <form action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
                ...
                <div class="form-group has-feedback {{ $errors->has('profession') ? 'has-error' : '' }}">
                    <input type="text" name="profession" class="form-control" value="{{ old('profession') }}"
                           placeholder="{{ trans('adminlte::adminlte.profession') }}">
                ...
                <div class="form-group has-feedback {{ $errors->has('invitation') ? 'has-error' : '' }}">
                    <input type="text" name="invitation" class="form-control" value="{{ old('invitation') }}"
                           placeholder="{{ trans('adminlte::adminlte.invitation') }}">
